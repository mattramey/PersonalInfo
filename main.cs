using System;// this imports the entire System namespace into the program



namespace PersonNameSpace {// open personNameSpace

    public class Person {// open class person
...
//$" notates string interpolation 
    ...
    class PersonalInfo{// open class PersonalInfo
        public static void Main(string[] args) {

// declare an array of type person  called people and initialize it to set values.
            Person[] people = new Person[] {// open array person
      new Person{ // person 1
        Name = "Lucinda Potter",
